...
function generateRegexQuery({ keyword, sensitive = false, ignoreAccentedVietnamese = false, outputCaseOptions, }) {
    ...
    switch (outputCaseOptions) {
        ...
        case enums_1.OutputCaseOptions.both:
            ...
            break;
        case enums_1.OutputCaseOptions.sameInput:
        default:
    ...
    const regexString = Array.from(normalizedKeyword, (char) => {
        var _a;
        const variationsSet = (_a = variations.get(char)) !== null && _a !== void 0 ? _a : new Set(
        // If not a special character, return the character itself.
        outputCaseOptions === enums_1.OutputCaseOptions.both
